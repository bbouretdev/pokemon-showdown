export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	gengar: {
		...
		abilities: {0: "Cursed Body", 1: "Haunting Pact", H: "Set Volatile"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "Haunter",
	...
	marowak: {
		...
		abilities: {0: "Rock Head", 1: "Spiritual Vengeance", H: "Battle Armor"},
		heightm: 1,
		weightkg: 45,
		color: "Brown",
		prevo: "Cubone",
	...
	kangaskhan: {
		...
		abilities: {0: "Spiritual Vengeance", 1: "Scrappy", H: "Inner Focus"},
		heightm: 2.2,
		weightkg: 80,
		color: "Brown",
		eggGroups: ["Monster"],
